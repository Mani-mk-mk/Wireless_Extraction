...
"}")
        ...
        self.texts.setMinimumSize(QSize(0, 80))
...
"}")
        ...
        self.version.setLayoutDirection(Qt.LeftToRight)
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        SplashScreen.setWindowTitle(QCoreApplication.translate("SplashScreen", u"Loading_Bar", None))
        self.title.setText(QCoreApplication.translate("SplashScreen", u"Modern GUI", None))
        self.loading.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        self.version.setText(QCoreApplication.translate("SplashScreen", u"v.0.0.1 - Beta 1", None))
    # retranslateUi
